...
import { ANIMAL_LOGS_OPTIONS, ANIMAL_TYPE_ICONS, ANIMAL_TYPE_LABELS } from 'kadesh/components/animals/constants';
    ...
    return (
      <main className="min-h-screen bg-[#f5f5f5] dark:bg-[#0a0a0a]">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <p className="text-[#616161] dark:text-[#b0b0b0]">Cargando...</p>
        </div>
        <Footer />
      </main>
    );
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#212121] dark:text-[#ffffff] mb-2">
                Nombre del Animal <span className="text-red-500">*</span>
              </label>
              <input
                id="name"
                type="text"
            ...
            {/* Status */}
            <div>
              <label htmlFor="status" className="block text-sm font-medium text-[#212121] dark:text-[#ffffff] mb-2">
              ...
              <select
                ...
                required
                className="w-full px-4 py-2 rounded-lg border border-[#e0e0e0] dark:border-[#3a3a3a] bg-white dark:bg-[#121212] text-[#212121] dark:text-[#ffffff] focus:outline-none focus:ring-2 focus:ring-orange-500 dark:focus:ring-orange-400"
              >
