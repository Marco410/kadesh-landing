...
export default function ConocenosPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f5f5f5] dark:bg-[#0a0a0a]">
      ...
      {/* Mission & Vision */}
      <section className="py-16 sm:py-24 bg-[#f5f5f5] dark:bg-[#0a0a0a]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              KADESH ofrece múltiples servicios para conectar y apoyar a la comunidad animal
            </p>
          </motion.div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-orange-500 to-orange-600">
